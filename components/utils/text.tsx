...
const Text = styled.span<StyledProps<Text>>`
  ...
  text-align: ${(props) =>
    props.align ? props.align : props.theme.dir === "rtl" ? "right" : "left"};
  padding: ${(props) => {
  ...
  font-size: ${(props) => {
    if (props && Number.isInteger(props.size)) return `${props.size}px`;
      ...
      else if (props.size === "small") return ".5em";
      else if (props.size === "normal") return "1em";
    }
  }};
